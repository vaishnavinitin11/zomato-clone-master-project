    ...
    <>
      <div className="hidden md:flex items-center justify-between container px-20 mx-auto">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-1 text-lg font-light h-10 bg-zomato-400 px-3 py-1 text-white rounded-lg">
            Continue <IoMdArrowDropright />
          </button>
        </div>
      </div>
...
const CartContainer = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 w-full bg-white z-10 p-2 px-3">
